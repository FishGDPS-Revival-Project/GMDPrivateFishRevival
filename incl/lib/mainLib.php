...
class mainLib {
    ...
    public function getIP(){
        ...
        if(isset($_SERVER['HTTP_X_FORWARDED_FOR']) && ipInRange::ipv4_in_range($_SERVER['REMOTE_ADDR'], '127.0.0.0/8')) //LOCALHOST REVERSE PROXY SUPPORT (7m.pl)
            return explode(",", $_SERVER['HTTP_X_FORWARDED_FOR'])[0]; // f**k my life
        if(isset($_SERVER['HTTP_X_FORWARDED_FOR']) && $_SERVER['REMOTE_ADDR'] == "10.0.1.10") // 141412 PROXY SUPPORT F**K YOU HESTIA
            return explode(",", $_SERVER['HTTP_X_FORWARDED_FOR'])[0]; // f**k my life

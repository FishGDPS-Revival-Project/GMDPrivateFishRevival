...
$isWeekly = !empty($_POST["isWeekly"]) ? ExploitPatch::remove($_POST["isWeekly"]) : 0;
$isDeleted = !empty($_POST["isDeleted"]) ? ExploitPatch::remove($_POST["isDeleted"]) : 0;
$isMagic = !empty($_POST["isMagic"]) ? ExploitPatch::remove($_POST["isMagic"]) : 0;

if (str_contains($levelDesc, 'unlisted')) {
$unlisted = 1;
}
